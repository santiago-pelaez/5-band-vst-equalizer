    ...
    static juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
    {
        ...
        auto createBandParams = [&](int bandNum, BandPosition position)
        {
            ...
            for (auto type : availableTypes)
            {
                switch (type)
                {
                    case FilterType::Peak:      filterChoices.add("Peak"); break;
                    case FilterType::LowCut:    filterChoices.add("Low Cut"); break;
                    case FilterType::LowShelf:  filterChoices.add("Low Shelf"); break;
                    case FilterType::HighCut:   filterChoices.add("High Cut"); break;
                    case FilterType::HighShelf: filterChoices.add("High Shelf"); break;
                    case FilterType::Disabled:  filterChoices.add("Disabled"); break;
                }
            }
